...
class JmeterIndexCommand extends BaseCommand { // <-- CHANGE THIS
  static description = 'Commands for JMeter automation.';
...
module.exports = JmeterIndexCommand;